      ...
      <div className="flex flex-col flex-1 p-2 sm:p-2.5 gap-1 sm:gap-1.5">
        ...
        <div className="pt-1.5 sm:pt-2 border-t border-border/80 mt-auto">
          <div className="grid grid-cols-2 gap-x-1 sm:gap-x-1.5 gap-y-0.5 sm:gap-y-1 text-[12px] xs:text-[12px] sm:text-[13px]">
            <div className="flex min-w-0 justify-between items-center gap-1 bg-red-500/5 dark:bg-red-500/10 px-1 sm:px-1.5 py-0.5 rounded border border-red-500/15">
              <span className="shrink-0 text-muted-foreground font-semibold">Vốn:</span>
              <span className="min-w-0 truncate text-right font-bold tabular-nums text-red-600 dark:text-red-400" title={product.gia_von ? formatVnd(product.gia_von) : 'Liên hệ'}>
                {product.gia_von ? formatVnd(product.gia_von) : 'L.Hệ'}
              </span>
            </div>
            <div className="flex min-w-0 justify-between items-center gap-1 bg-amber-500/5 dark:bg-amber-500/10 px-1 sm:px-1.5 py-0.5 rounded border border-amber-500/15">
              <span className="shrink-0 text-muted-foreground font-semibold">VIP:</span>
              <span className="min-w-0 truncate text-right font-bold tabular-nums text-amber-600 dark:text-amber-400" title={product.gia_vip ? formatVnd(product.gia_vip) : 'Liên hệ'}>
                {product.gia_vip ? formatVnd(product.gia_vip) : 'L.Hệ'}
              </span>
            </div>
            <div className="flex min-w-0 justify-between items-center gap-1 bg-orange-500/5 dark:bg-orange-500/10 px-1 sm:px-1.5 py-0.5 rounded border border-orange-500/15">
              <span className="shrink-0 text-muted-foreground font-semibold">U.Đãi:</span>
              <span className="min-w-0 truncate text-right font-bold tabular-nums text-orange-600 dark:text-orange-400" title={product.gia_uu_dai ? formatVnd(product.gia_uu_dai) : 'Liên hệ'}>
                {product.gia_uu_dai ? formatVnd(product.gia_uu_dai) : 'L.Hệ'}
              </span>
            </div>
            <div className="flex min-w-0 justify-between items-center gap-1 bg-blue-500/5 dark:bg-blue-500/10 px-1 sm:px-1.5 py-0.5 rounded border border-blue-500/15">
              <span className="shrink-0 text-muted-foreground font-semibold">Đ.Lý:</span>
              <span className="min-w-0 truncate text-right font-bold tabular-nums text-blue-600 dark:text-blue-400" title={product.gia_dai_ly ? formatVnd(product.gia_dai_ly) : 'Liên hệ'}>
                {product.gia_dai_ly ? formatVnd(product.gia_dai_ly) : 'L.Hệ'}
              </span>
            </div>
            <div className="flex min-w-0 justify-between items-center gap-1 bg-purple-500/5 dark:bg-purple-500/10 px-1 sm:px-1.5 py-0.5 rounded border border-purple-500/15">
