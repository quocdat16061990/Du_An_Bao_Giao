$(document).ready(function () {
    if($('#estimation-report').length > 0) {
		$('#estimation-report').DataTable({
				"bFilter": false, 
				"bInfo": false,
					"ordering": true,
				"autoWidth": true,
			...
			"columns": [
                ...
                { "data": "start_date" },	
				 { "data": "value" },		
                { "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 mb-0 fw-medium"><a href="#" class="avatar avatar-sm border rounded-circle me-2"><img class="rounded-circle" src="'+row['mem_image3']+'" alt="User Image"></a><a href="#">'+row['name']+'</a></h6>';
				}}, 
				{ "render": function ( data, type, row ){
