$(document).ready(function () {
    if($('#sales-target-settings').length > 0) {
		$('#sales-target-settings').DataTable({
				"bFilter": false, 
				"bInfo": false,
					"ordering": true,
				"autoWidth": true,
			...
			"columns": [
				...
				{ "data": "value" },
				{ "render": function ( data, type, row ){
					if(row['status'] == "0") { var class_name = "bg-success";var status_name ="Completed" } else if(row['status'] == "1") { var class_name = "bg-warning";var status_name ="Inprogress"}  else { var class_name = "bg-danger";var status_name ="Failed"}
