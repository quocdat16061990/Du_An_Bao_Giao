$(document).ready(function () {
    if($('#contract-report').length > 0) {
		$('#contract-report').DataTable({
				"bFilter": false, 
				"bInfo": false,
					"ordering": true,
				"autoWidth": true,
			...
			"columns": [
                ...
                { "data": "end_date" }, 
				{ "render": function ( data, type, row ){
					if(row['status'] == "0") { var class_name = "bg-success";var status_name ="Active" }  else if(row['status'] == "1") { var class_name = "bg-danger";var status_name ="Rejected"} else { var class_name = "bg-warning";var status_name ="Upcoming"}
